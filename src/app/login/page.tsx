  ...
  return (
    <div className="flex min-h-screen bg-zinc-950">
      ...
      <div className="flex w-full flex-col items-center justify-center px-4 py-12 lg:w-5/12 lg:px-12 xl:px-24 relative z-10">
        {/* Background glow for form panel */}
        ...
        >
          ...
          <div className="mb-8 flex flex-col items-center lg:items-start gap-3">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="mt-1.5 text-sm text-zinc-400">Sign in to your BookEasy account</p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4.5">
              <div className="flex flex-col gap-2 mb-4">
                ...
                <Input id="email" type="email" placeholder="you@example.com" autoComplete="email"
                  className="border-zinc-700 bg-zinc-950/50 text-zinc-100 placeholder:text-zinc-600 focus-visible:border-emerald-500 focus-visible:ring-emerald-500/20 transition-all h-10"
          ...
          <p className="mt-6 text-center text-sm text-zinc-500 lg:text-left">
            ...
            <Link href="/register" className="font-medium text-emerald-400 hover:text-emerald-300 transition-colors">Sign up</Link>
          </p>
        </motion.div>
      </div>
